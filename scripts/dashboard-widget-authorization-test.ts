...
assert(
  appReleases.some((release) => release.version === "0.2.0" && release.status === "PUBLISHED" && release.type === "MINOR") &&
    ...
    appReleases.some((release) => release.version === "0.2.5" && release.status === "PUBLISHED" && release.releaseDate === "2026-08-29") &&
    appReleases.some((release) => release.version === "0.2.6" && release.status === "PUBLISHED" && release.releaseDate === "2026-09-07") &&
    ...
    appReleases.filter((release) => release.status === "UNRELEASED").length === 1,
