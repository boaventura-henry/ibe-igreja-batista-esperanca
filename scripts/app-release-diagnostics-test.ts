...
const unreleasedReleases: AppRelease[] = [
  ...publishedReleases,
  { version: "0.2.3", title: "Futura", summary: "Entrega ainda nao publicada.", type: "PATCH", status: "UNRELEASED", releaseDate: null, highlights: ["Em desenvolvimento"] }
];
...
await assert.rejects(() => markPublishedReleaseAsSeen({ userId: "user-1", version: "0.2.3" }, { releases: unreleasedReleases }), /nao foi publicada/i, "7: versao futura nao publicada e rejeitada");
