export type ScheduleSongSummary = {
  ...
  leadMember: { id: string; name: string; nickname: string | null; displayName: string; status: string } | null; createdAt: string; updatedAt: string;
};
...
export type ScheduleRepertoireResult = { songs: ScheduleSongSummary[]; members: Array<{ id: string; name: string; nickname: string | null; displayName: string; status: string }>; sources: Array<{ id: string; title: string; date: string; songCount: number }> };
