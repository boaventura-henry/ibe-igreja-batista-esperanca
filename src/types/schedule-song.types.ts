export type ScheduleSongSummary = {
  ...
  song: { id: string; title: string; artist: string | null; youtubeUrl: string | null; referenceKey: string | null; resourceUrl: string | null; simplifiedResourceUrl: string | null };
