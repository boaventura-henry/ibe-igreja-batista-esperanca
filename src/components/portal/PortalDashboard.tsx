      ...
      <section className="rounded-md border border-hope-100 bg-white p-5 shadow-sm lg:col-span-2">
        ...
        {data.nextSchedule ? (
          <div className="mt-4 rounded-md border border-hope-100 p-4">
            ...
            <p className="mt-1 whitespace-normal break-words text-sm font-semibold text-ink-700">
              <span className="sr-only">Funções: </span>
              {getScheduleMemberDisplayRoles(data.nextSchedule, data.nextSchedule.instrumentAssignment)}
            </p>
