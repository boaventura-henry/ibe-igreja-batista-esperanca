...
export const availablePermissions = [
  ...
  { code: "dashboard.finance.ministryBalances", name: "Visualizar saldos por ministerio", label: "Saldo por ministerio", description: "Permite visualizar saldos acumulados dos ministerios autorizados.", module: "Dashboard - Financeiro" },
  ...
  { code: "instrument.view", name: "Visualizar instrumentos", label: "Visualizar instrumentos", module: "Instrumentos" },
  { code: "instrument.create", name: "Criar instrumentos", label: "Criar instrumentos", module: "Instrumentos" },
  { code: "instrument.update", name: "Alterar instrumentos", label: "Alterar instrumentos", module: "Instrumentos" },
  { code: "instrument.delete", name: "Excluir instrumentos", label: "Excluir instrumentos", module: "Instrumentos" },
  { code: "instrument.history.view", name: "Visualizar historico de instrumentos", label: "Visualizar historico", module: "Instrumentos" },
  { code: "instrument.history.create", name: "Registrar historico de instrumentos", label: "Registrar historico", module: "Instrumentos" },
  { code: "instrument.history.update", name: "Alterar historico de instrumentos", label: "Alterar historico", module: "Instrumentos" },
  { code: "instrument.category.manage", name: "Gerenciar categorias de instrumentos", label: "Gerenciar categorias", module: "Instrumentos" },
  ...
  { code: "ministryFinance.view", name: "Visualizar financeiro ministerial", label: "Visualizar movimentacoes ministeriais", module: "Financeiro por Ministerio" },
  { code: "ministryFinance.create", name: "Criar movimentacoes ministeriais", label: "Criar movimentacoes", module: "Financeiro por Ministerio" },
  { code: "ministryFinance.update", name: "Alterar movimentacoes ministeriais", label: "Alterar movimentacoes", module: "Financeiro por Ministerio" },
  { code: "ministryFinance.delete", name: "Excluir movimentacoes ministeriais", label: "Excluir movimentacoes", module: "Financeiro por Ministerio" },
  { code: "ministryFinance.cancel", name: "Cancelar movimentacoes ministeriais", label: "Cancelar movimentacoes", module: "Financeiro por Ministerio" },
  { code: "ministryFinance.report", name: "Consultar relatorio financeiro ministerial", label: "Consultar relatorio", module: "Financeiro por Ministerio" },
  { code: "ministryFinance.access.manage", name: "Configurar acessos financeiros ministeriais", label: "Configurar acessos", module: "Financeiro por Ministerio" },
