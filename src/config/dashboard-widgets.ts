...
export type DashboardWidgetComponentKey = "MEMBERS_BIRTHDAYS" | "MEMBERS_SUMMARY" | "EVENTS_UPCOMING" | "SCALES_UPCOMING" | "FINANCE_REVENUE" | "FINANCE_BALANCE" | "FINANCE_SUMMARY" | "FINANCE_MINISTRY_BALANCES" | "CONTRIBUTIONS_RECENT" | "ANNOUNCEMENTS_SUMMARY" | "NOTIFICATIONS_HEALTH";
...
export const dashboardWidgets = [
  ...
  { code: "finance.ministryBalances", title: "Saldo por ministerio", description: "Saldos acumulados dos ministerios com movimentacao.", category: "FINANCE", permissionCode: "dashboard.finance.ministryBalances", defaultOrder: 95, componentKey: "FINANCE_MINISTRY_BALANCES", sensitivity: "RESTRICTED", priority: "NORMAL", defaultSize: "MEDIUM", defaultVisibleOnMobile: true, defaultVisibleOnTablet: true, defaultVisibleOnDesktop: true, iconKey: "WALLET", visualVariant: "RESTRICTED", badge: { label: "Restrito", type: "NEUTRAL" }, enabled: true },
